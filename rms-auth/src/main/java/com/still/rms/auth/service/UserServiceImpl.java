...
import com.still.rms.auth.dao.AuthUserCustomMapper;
import com.still.rms.auth.dao.AuthUserRoleCustomMapper;
...
import com.still.rms.common.utils.JwtHelper;
import com.still.rms.mbg.mapper.AuthUserMapper;
...
//        map.put("menus",JSONObject.toJSONString(menuService.getMenuBYUserId(user.getId())));
    ...
    public void logout(String token) {
        Map map = JwtHelper.verifyToken(token.replace("rms",""));
